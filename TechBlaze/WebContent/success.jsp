...
<%@ taglib uri="http://displaytag.sf.net" prefix="display"%>
			...
			<div id="carousel-slider" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">						
						...
						<div class="carousel-caption">
							...
							<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">								
								<p>We shares top laptop picks for your lifestyle. Compare laptop features to find the best laptop to fit your needs.</p>
							</div>
				    ...
				    <div class="item">
						...
						<div class="carousel-caption">
							...
							<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="1.3s">								
								<p>Shop for All Laptops at Sai Om Computers. Find low everyday prices and buy online for delivery or in-store pick-up.</p>
							</div>
				    ...
				    <div class="item">
						...
						<div class="carousel-caption">
							<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.3s">								
								<h2>Deal with all kind of systems</h2>
							</div>
							<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">								
								<p>Shop Sai Om Computers for the best laptop or notebook computer to meet your needs at home, school, or work.</p>
							</div>
							<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.9s">								
								<form class="form-inline">
									<div class="form-group">
				...
				<div class="col-md-3 wow fadeInLeft" data-wow-offset="0" data-wow-delay="0.3s">
					<div class="text-center">
						<div class="hi-icon-wrap hi-icon-effect">
							...
							<h2>Security</h2>
							<p>Security is a very important issue on software development, especially for web or mobile based ones which may have millions of users with the ability of remote accessing to system. You should construct a security policy and apply it correctly by leaving no entry points. This may include authorization and authentication techniques, network attack protections, data encryption and so on. all possible types of security leaks should be considered, otherwise one day only one attack may crash your whole applicaion and whole company.</p>
						</div>
					</div>
				</div>
			</div>
	...
	<div id="gallery">
		<div class="container">
			<div class="text-center">
				<h3>Rent Services</h3>
				<p>Best Deals in Computers on rent or lease on laptop & computer Rent services.Also best deals on buy laptop or computers, We provide Rent service also.</p>
			</div>
			<div class="row">
	...
	<div id="pricing">
		<div class="container">
			<div class="text-center">
				<h3>Products List & Pricing</h3>
				<p>Online shopping from the earth's biggest selection of electronics, computers, software, accessories, tools & hardware, broadband & dsl & just about anything else.</p>
			</div>
			
			<div class="pricing-area text-center">
                <div class="row">
                 <c:forEach items="${productBeans}" var="prod">
                    <div class="col-sm-4 plan price-two wow fadeInDown" data-wow-offset="0" data-wow-delay="0.2s">
                        <ul>
                            <li class="heading-two">
                                <h2><c:out value="${prod.prodCatNm}"></c:out></h2>
                                <span><c:out value="${prod.productName}"></c:out></span>
                            </li>
                            <li><strike>MRP- <c:out value="${prod.mrp}"></c:out></strike> <font color="red">OFFER PRICE- <c:out value="${prod.offerPrice}"></c:out></font></li>
                            <li><c:out value="${prod.prodDesc}"></c:out></li>
                     ...
                     <%--  <div class="col-sm-4 plan price-one wow fadeInDown" data-wow-offset="0" data-wow-delay="0.6s">
                        <ul>
